...
function(b){_services_submission_error_handler(a)});b.addEventListener("abort",function(a){});b.addEventListener("timeout",function(b){_services_submission_error_handler(a)});b.onload=function(e){try{var g=b.status+" - "+http_status_code_title(b.status);if(200==b.status)Drupal.settings.debug&&console.log("200 - OK"),e=null,e=-1!=b.getResponseHeader("Content-Type").indexOf("application/json")?JSON.parse(b.responseText):b.responseText,module_invoke_all("services_request_pre_postprocess_alter",a,e),
"undefined"!==typeof a.success&&a.success(e),module_invoke_all("services_request_postprocess_alter",a,e),module_invoke_all("services_postprocess",a,e);else{Drupal.settings.debug&&(console.log(d+": "+c+" - "+g),console.log(b.responseText),console.log(b.getAllResponseHeaders()));b.responseText?console.log(b.responseText):dpm(b);if("undefined"!==typeof a.error){var h=b.responseText||"";h&&""!=h||(h=g);a.error(b,b.status,h)}a.retry=!1;_services_submission_error_handler(a)}_services_process_submission_queue()}catch(k){Drupal.settings.debug&&
(console.log(d+" (ERROR): "+c+" - "+g),console.log(b.responseText),console.log(b.getAllResponseHeaders())),console.log("Drupal.services.call - onload - "+k),_services_submission_error_handler(a)}};services_get_csrf_token({debug:a.debug,success:function(e){try{var g=!0;"undefined"!==typeof a.async&&!1===a.async&&(g=!1);b.open(d,c,g);g=null;"POST"==d?(g="application/json","user"==a.service&&"login"==a.resource&&(g="application/x-www-form-urlencoded")):"PUT"==d&&(g="application/json");a.contentType&&
(g=a.contentType);g&&b.setRequestHeader("Content-type",g);e&&b.setRequestHeader("X-CSRF-Token",e);"undefined"!==typeof a.data?(Drupal.settings.debug&&(e=!0,"user"==a.service&&in_array(a.resource,["login","create","update"])&&(e=!1),e&&("object"===typeof a.data?console.log(JSON.stringify(a.data)):console.log(a.data))),b.send(a.data)):b.send(null)}catch(h){console.log("Drupal.services.call - services_get_csrf_token - success - "+h),_services_submission_error_handler(a)}},error:function(b,c,d){try{console.log("Drupal.services.call - services_get_csrf_token - "+
d)}catch(e){console.log("Drupal.services.call - services_get_csrf_token - error - "+e)}_services_submission_error_handler(a)}})}else a.error(null,null,"Set the site_path and endpoint on Drupal.settings!")}catch(e){console.log("Drupal.services.call - error - "+e)}};
function services_get_csrf_token(a){try{var b;a.reset&&(Drupal.sessid=null);Drupal.sessid&&(b=Drupal.sessid);if(b)a.success&&a.success(b);else{var c=new XMLHttpRequest,d=Drupal.settings.site_path+Drupal.settings.base_path+"?q=services/session/token";c.addEventListener("error",function(b){a.error&&a.error()});c.addEventListener("abort",function(a){});c.addEventListener("timeout",function(b){a.error&&a.error()});c.onload=function(e){try{var g=c.status+" - "+http_status_code_title(c.status);200!=c.status?
(a.error&&a.error(),console.log(d+" - "+g),console.log(c.responseText)):(b=c.responseText,Drupal.sessid=b,a.success&&a.success(b))}catch(h){a.error&&a.error(),console.log("services_get_csrf_token - token_request. onload - "+h)}};c.open("GET",d,!0);c.send(null)}}catch(e){console.log("services_get_csrf_token - "+e)}}
