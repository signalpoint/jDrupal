...
function(b){_services_submission_error_handler(a)});b.addEventListener("abort",function(a){});b.addEventListener("timeout",function(b){_services_submission_error_handler(a)});b.onload=function(e){try{var f=b.status+" - "+http_status_code_title(b.status);if(200==b.status)Drupal.settings.debug&&console.log("200 - OK"),e=null,e=-1!=b.getResponseHeader("Content-Type").indexOf("application/json")?JSON.parse(b.responseText):b.responseText,module_invoke_all("services_request_pre_postprocess_alter",a,e),
"undefined"!==typeof a.success&&a.success(e),module_invoke_all("services_request_postprocess_alter",a,e),module_invoke_all("services_postprocess",a,e);else{Drupal.settings.debug&&(console.log(d+": "+c+" - "+f),console.log(b.responseText),console.log(b.getAllResponseHeaders()));b.responseText?console.log(b.responseText):dpm(b);if("undefined"!==typeof a.error){var g=b.responseText||"";g&&""!=g||(g=f);a.error(b,b.status,g)}a.retry=!1;_services_submission_error_handler(a)}_services_process_submission_queue()}catch(h){Drupal.settings.debug&&
(console.log(d+" (ERROR): "+c+" - "+f),console.log(b.responseText),console.log(b.getAllResponseHeaders())),console.log("Drupal.services.call - onload - "+h),_services_submission_error_handler(a)}};services_get_csrf_token({debug:a.debug,success:function(e){try{var f=!0;"undefined"!==typeof a.async&&!1===a.async&&(f=!1);b.open(d,c,f);f=null;"POST"==d?(f="application/json","user"==a.service&&"login"==a.resource&&(f="application/x-www-form-urlencoded")):"PUT"==d&&(f="application/json");a.contentType&&
(f=a.contentType);f&&b.setRequestHeader("Content-type",f);e&&b.setRequestHeader("X-CSRF-Token",e);"undefined"!==typeof a.data?(Drupal.settings.debug&&(e=!0,"user"==a.service&&in_array(a.resource,["login","create","update"])&&(e=!1),e&&("object"===typeof a.data?console.log(JSON.stringify(a.data)):console.log(a.data))),b.send(a.data)):b.send(null)}catch(g){console.log("Drupal.services.call - services_get_csrf_token - success - "+g),_services_submission_error_handler(a)}},error:function(b,c,d){try{console.log("Drupal.services.call - services_get_csrf_token - "+
d)}catch(h){console.log("Drupal.services.call - services_get_csrf_token - error - "+h)}_services_submission_error_handler(a)}})}else a.error(null,null,"Set the site_path and endpoint on Drupal.settings!")}catch(e){console.log("Drupal.services.call - error - "+e)}};
function services_get_csrf_token(a){try{var b;a.reset&&(Drupal.sessid=null);Drupal.sessid&&(b=Drupal.sessid);if(b)a.success&&a.success(b);else{var c=new XMLHttpRequest,d=Drupal.settings.site_path+Drupal.settings.base_path+"?q=services/session/token";c.addEventListener("error",function(b){a.error&&a.error()});c.addEventListener("abort",function(a){});c.addEventListener("timeout",function(b){a.error&&a.error()});c.onload=function(e){try{var f=c.status+" - "+http_status_code_title(c.status);200!=c.status?
(a.error&&a.error(),console.log(d+" - "+f),console.log(c.responseText)):(b=c.responseText,Drupal.sessid=b,a.success&&a.success(b))}catch(g){a.error&&a.error(),console.log("services_get_csrf_token - token_request. onload - "+g)}};c.open("GET",d,!0);c.send(null)}}catch(e){console.log("services_get_csrf_token - "+e)}}
