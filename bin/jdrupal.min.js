...
function date(a,b){try{var c=null;b?c=new Date(b):(c=new Date,c.getTime());for(var d="",e=0;e<a.length;e++){var f=a.charAt(e);switch(f){case "d":var g=""+c.getDate();1==g.length&&(g="0"+g);d+=g;break;case "D":g=c.getDay();switch(g){case 0:d+="Sun";break;case 1:d+="Mon";break;case 2:d+="Tue";break;case 3:d+="Wed";break;case 4:d+="Thu";break;case 5:d+="Fri";break;case 6:d+="Sat"}break;case "m":var h=""+(c.getMonth()+1);1==h.length&&(h="0"+h);d+=h;break;case "Y":d+=c.getFullYear();break;case "H":var k=
""+c.getHours();1==k.length&&(k="0"+k);d+=k;break;case "i":var l=""+c.getMinutes();1==l.length&&(l="0"+l);d+=l;break;default:d+=f}}return d}catch(m){console.log("date - "+m)}}function dpm(a,b){try{a?"function"===typeof parent.window.ripple?"undefined"!==typeof b&&!1==b?console.log(JSON.stringify(a)):console.log(a):"object"===typeof a?console.log(JSON.stringify(a)):console.log(a):console.log("<null>")}catch(c){console.log("dpm - "+c)}}
