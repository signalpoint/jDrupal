...
function drupal_init(){try{Drupal||(Drupal={}),Drupal.bootstrapped=!1,Drupal.csrf_token=!1,Drupal.sessid=null,Drupal.user=drupal_user_defaults(),Drupal.settings={app_directory:"app",base_path:"/",cache:{entity:{enabled:!1,expiration:3600}},debug:!1,endpoint:"",file_public_path:"sites/default/files",language_default:"und",site_path:""},Drupal.includes={},Drupal.includes.module={},Drupal.modules={core:{},contrib:{},custom:{}},drupal_bootstrap()}catch(a){console.log("drupal_init - "+a)}}
function drupal_bootstrap(){try{Drupal.bootstrapped=!0}catch(a){console.log("drupal_bootstrap - "+a)}}function drupal_load_settings(){try{var a=Drupal.settings.app_directory+"/settings.js",b=document.getElementsByTagName("head")[0],c=document.createElement("script");c.type="text/javascript";c.src=a;b.appendChild(c)}catch(d){console.log("drupal_load_settings - "+d)}}function dpm(a){try{a&&("object"===typeof a?console.log(JSON.stringify(a)):console.log(a))}catch(b){console.log("dpm - "+b)}}
<<<<<<< HEAD
function drupal_user_defaults(){return{uid:"0",roles:{1:"anonymous user"},permissions:[]}}function empty(a){return"undefined"===typeof a||null===a||""==a}function function_exists(a){try{return"function"==eval("typeof "+a)}catch(b){alert("function_exists - "+b)}}
...
function entity_assemble_data(a,b,c,d){try{a="";for(var e in c)if(c.hasOwnProperty(e))if("object"===typeof c[e])for(var f in c[e]){if(c[e].hasOwnProperty(f))for(var g in c[e][f])if(c[e][f].hasOwnProperty(g))for(var h in c[e][f][g])c[e][f][g].hasOwnProperty(h)&&!empty(c[e][f][g][h])&&(a+=e+"["+f+"]["+g+"]["+h+"]="+encodeURIComponent(c[e][f][g][h])+"&")}else empty(c[e])||(a+=e+"="+encodeURIComponent(c[e])+"&");""!=a&&(a=a.substring(0,a.length-1));return a}catch(k){console.log("entity_assemble_data - "+
k)}}function entity_delete(a,b,c){try{var d=a+"_delete";if(function_exists(d))(0,window[d])(b,c);else console.log("WARNING: entity_delete - unsupported type: "+a)}catch(e){console.log("entity_delete - "+e)}}function entity_local_storage_key(a,b){return a+"_"+b}
...
a)}catch(f){console.log("entity_save - "+f)}}function entity_types(){return"comment file node taxonomy_term taxonomy_vocabulary user".split(" ")}function file_load(a,b){try{entity_load("file",a,b)}catch(c){console.log("file_load - "+c)}}function node_load(a,b){try{entity_load("node",a,b)}catch(c){console.log("node_load - "+c)}}function node_save(a,b){try{entity_save("node",a.type,a,b)}catch(c){console.log("node_save - "+c)}}
function taxonomy_term_load(a,b){try{entity_load("taxonomy_term",a,b)}catch(c){console.log("taxonomy_term_load - "+c)}}function taxonomy_term_save(a,b){try{entity_save("taxonomy_term",null,a,b)}catch(c){console.log("taxonomy_term_save - "+c)}}function taxonomy_vocabulary_load(a,b){try{entity_load("taxonomy_vocabulary",a,b)}catch(c){console.log("taxonomy_vocabulary_load - "+c)}}
...
Drupal.services.call=function(a){try{if(a.debug=!1,services_ready()){var b=new XMLHttpRequest,c=Drupal.settings.site_path+Drupal.settings.base_path+"?q=";"undefined"===typeof a.endpoint?c+=Drupal.settings.endpoint+"/":""!=a.endpoint&&(c+=a.endpoint+"/");var c=c+a.path,d=a.method.toUpperCase();console.log(d+": "+c);b.onload=function(e){try{if(4==b.readyState){var g=b.status+" - "+http_status_code_title(b.status);if(200==b.status){console.log("200 - OK");var h=JSON.parse(b.responseText);module_invoke_all("services_request_postprocess_alter",
a,h);a.success(h)}else if(console.log(d+": "+c+" - "+g),dpm(b),b.responseText?console.log(b.responseText):dpm(b),"undefined"!==typeof a.error){var k=b.responseText||"";k&&""!=k||(k=g);a.error(b,b.status,k)}}else console.log("Drupal.services.call - request.readyState = "+b.readyState)}catch(l){console.log("Drupal.services.call - onload - "+l)}};services_get_csrf_token({debug:a.debug,success:function(e){try{b.open(d,c,!0),"POST"==d?b.setRequestHeader("Content-type","application/x-www-form-urlencoded"):
"PUT"==d&&b.setRequestHeader("Content-type","application/json"),e&&b.setRequestHeader("X-CSRF-Token",e),"undefined"!==typeof a.data?("user/login.json"!=a.path&&("object"===typeof a.data?console.log(JSON.stringify(a.data)):console.log(a.data)),b.send(a.data)):b.send(null)}catch(g){console.log("Drupal.services.call - services_get_csrf_token - success - "+g)}},error:function(b,c,d){try{console.log("Drupal.services.call - services_get_csrf_token - "+d),a.error&&a.error(b,c,d)}catch(e){console.log("Drupal.services.call - services_get_csrf_token - error - "+
e)}}})}else a.error(null,null,"Set the site_path and endpoint on Drupal.settings!")}catch(e){console.log("Drupal.services.call - error - "+e)}};
