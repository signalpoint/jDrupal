...
function user_register(a,b){try{Drupal.services.call({service:"user",resource:"register",method:"POST",path:"user/register.json",data:JSON.stringify(a),success:function(a){try{Drupal.sessid=null,services_get_csrf_token({success:function(c){try{b.success&&system_connect({success:function(c){try{Drupal.sessid=c.sessid,Drupal.user=c.user,b.success&&b.success(a)}catch(e){console.log("user_register - system_connect - success - "+e)}},error:function(a,c,d){try{b.error&&b.error(a,c,d)}catch(e){console.log("user_register - system_connect - error - "+
e)}}})}catch(e){console.log("user_register - services_get_csrf_token - success - "+e)}},error:function(a,c,d){console.log("user_register - services_get_csrf_token - error - "+d);b.error&&b.error(a,c,d)}})}catch(c){console.log("user_register - success - "+c)}},error:function(a,c,f){try{b.error&&b.error(a,c,f)}catch(g){console.log("user_register - error - "+g)}}})}catch(c){console.log("user_retrieve - "+c)}}
