...
function drupal_init(){try{Drupal||(Drupal={}),Drupal.sessid=null,Drupal.user=drupal_user_defaults(),Drupal.settings={app_directory:"app",base_path:"/",cache:{entity:{enabled:!1,expiration:3600},views:{enabled:!1,expiration:3600}},debug:!1,endpoint:"",file_public_path:"sites/default/files",language_default:"und",site_path:""},Drupal.includes={},Drupal.includes.module={},Drupal.modules={core:{},contrib:{},custom:{}},Drupal.services_queue={comment:{retrieve:{}},file:{retrieve:{}},node:{retrieve:{}},
taxonomy_term:{retrieve:{}},taxonomy_vocabulary:{retrieve:{}},user:{retrieve:{}}}}catch(a){console.log("drupal_init - "+a)}}
...
console.log("200 - OK");e=null;var k=b.getResponseHeader("Content-Type");-1==k.indexOf("application/json")?(console.log("Drupal.services.call - ERROR - response header was "+k+" instead of application/json"),console.log(b.responseText)):e=JSON.parse(b.responseText);module_invoke_all("services_request_pre_postprocess_alter",a,e);a.success(e);module_invoke_all("services_request_postprocess_alter",a,e);module_invoke_all("services_postprocess",a,e)}else{Drupal.settings.debug&&(console.log(d+": "+c+" - "+
f),console.log(b.responseText),console.log(b.getAllResponseHeaders()));b.responseText?console.log(b.responseText):dpm(b);if("undefined"!==typeof a.error){var l=b.responseText||"";l&&""!=l||(l=f);a.error(b,b.status,l)}module_invoke_all("services_postprocess",a,b)}}else console.log("Drupal.services.call - request.readyState = "+b.readyState)}catch(m){Drupal.settings.debug&&(console.log(d+" (ERROR): "+c+" - "+f),console.log(b.responseText),console.log(b.getAllResponseHeaders())),console.log("Drupal.services.call - onload - "+
m)}};var e=!0;"undefined"!==typeof a.async&&!1===a.async&&(e=!1);b.open(d,c,e);e=null;"POST"==d?(e="application/json","user"==a.service&&"login"==a.resource&&(e="application/x-www-form-urlencoded")):"PUT"==d&&(e="application/json");a.contentType&&(e=a.contentType);e&&b.setRequestHeader("Content-type",e);"undefined"!==typeof a.data?(Drupal.settings.debug&&(e=!0,"user"==a.service&&in_array(a.resource,["login","create","update"])&&(e=!1),e&&("object"===typeof a.data?console.log(JSON.stringify(a.data)):
console.log(a.data))),b.send(a.data)):b.send(null)}else a.error(null,null,"Set the site_path and endpoint on Drupal.settings!")}catch(f){console.log("Drupal.services.call - error - "+f)}};function services_ready(){try{var a=!0;""==Drupal.settings.site_path&&(a=!1,console.log("jDrupal's Drupal.settings.site_path is not set!"));""==Drupal.settings.endpoint&&(a=!1,console.log("jDrupal's Drupal.settings.endpoint is not set!"));return a}catch(b){console.log("services_ready - "+b)}}
...
function node_retrieve(a,b){try{services_resource_defaults(b,"node","retrieve"),entity_retrieve("node",a,b)}catch(c){console.log("node_retrieve - "+c)}}
function node_update(a,b){try{"undefined"===typeof a.type?(console.log("node_update - missing 'type' value on the node's JSON object"),b.error&&b.error(null,406,"node_update - missing 'type' value on the node's JSON object")):(services_resource_defaults(b,"node","update"),entity_update("node",a.type,a,b))}catch(c){console.log("node_update - "+c)}}function node_delete(a,b){try{services_resource_defaults(b,"node","delete"),entity_delete("node",a,b)}catch(c){console.log("node_delete - "+c)}}
...
function user_create(a,b){try{services_resource_defaults(b,"user","create"),entity_create("user",null,a,b)}catch(c){console.log("user_create - "+c)}}function user_retrieve(a,b){try{services_resource_defaults(b,"user","retrieve"),entity_retrieve("user",a,b)}catch(c){console.log("user_retrieve - "+c)}}
function user_update(a,b){try{var c="create";a.uid&&(c="update");"update"==c&&"undefined"===typeof a.name?(console.log("user_update - missing 'name' value on the account's JSON obj"),b.error&&b.error(null,406,"user_update - missing 'name' value on the account's JSON obj")):(services_resource_defaults(b,"user",c),entity_update("user",null,a,b))}catch(d){console.log("user_update - "+d)}}
...
function user_login(a,b,c){try{var d=!0;a&&"string"===typeof a||(d=!1,console.log("user_login - invalid name"));b&&"string"===typeof b||(d=!1,console.log("user_login - invalid pass"));d?Drupal.services.call({service:"user",resource:"login",method:"POST",path:"user/login.json",data:"username="+encodeURIComponent(a)+"&password="+encodeURIComponent(b),success:function(a){try{Drupal.user=a.user,Drupal.sessid=null,system_connect({success:function(b){try{c.success&&c.success(a)}catch(d){console.log("user_login - system_connect - success - "+
d)}},error:function(a,b,d){try{c.error&&c.error(a,b,d)}catch(e){console.log("user_login - system_connect - error - "+e)}}})}catch(b){console.log("user_login - success - "+b)}},error:function(a,b,d){try{c.error&&c.error(a,b,d)}catch(e){console.log("user_login - error - "+e)}}}):c.error&&c.error(null,406,"user_login - bad input")}catch(e){console.log("user_login - "+e)}}
