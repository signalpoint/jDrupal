...
a,b)}}else console.log("Drupal.services.call - request.readyState = "+b.readyState)}catch(l){console.log("Drupal.services.call - onload - "+l)}};services_get_csrf_token({debug:a.debug,success:function(e){try{var g=!0;"undefined"!==typeof a.async&&!1===a.async&&(g=!1);b.open(d,c,g);"POST"==d?(g="application/json","user"==a.service&&"login"==a.resource&&(g="application/x-www-form-urlencoded"),b.setRequestHeader("Content-type",g)):"PUT"==d&&b.setRequestHeader("Content-type","application/json");e&&b.setRequestHeader("X-CSRF-Token",
